...
class TicketMapper {
  ...
  Ticket mapToEntity(TicketDto dto) {
    return Ticket(
      ...
      slaExceptionApprovedBy: dto.slaExceptionApprovedBy,
  ...
  TicketDto mapToDto(Ticket entity) {
    return TicketDto(
      ...
      firstRespondedAt: entity.firstRespondedAt,
      responseDueAt: entity.responseDueAt,
      resolutionDueAt: entity.resolutionDueAt,
      slaCompletedAt: entity.slaCompletedAt,
      slaBreachedAt: entity.slaBreachedAt,
      slaExceptionReason: entity.slaExceptionReason,
      slaExceptionApprovedBy: entity.slaExceptionApprovedBy,
