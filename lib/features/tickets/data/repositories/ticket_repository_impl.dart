  ...
  Future<Ticket> updateTicket(Ticket ticket) async {
    ...
    await _localDataSource.updateTicket(
      TicketDto(
        ...
        firstRespondedAt: existingTicket.firstRespondedAt,
        responseDueAt: existingTicket.responseDueAt,
        resolutionDueAt: existingTicket.resolutionDueAt,
        slaCompletedAt: existingTicket.slaCompletedAt,
        slaBreachedAt: existingTicket.slaBreachedAt,
        slaExceptionReason: existingTicket.slaExceptionReason,
        slaExceptionApprovedBy: existingTicket.slaExceptionApprovedBy,
